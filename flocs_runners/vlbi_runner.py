...
def delay_calibration(
    ...
    delay_calibrator: Annotated[
        cwl_file,
        Parameter(help="A delay calibrator catalogue in CSV format."),
    ],
    ...
    configfile: Annotated[
        cwl_file,
        Parameter(help="Settings for the delay calibration in delay_solve."),
...
def phaseup_concat(
    ...
    selfcal: Annotated[
        cwl_dir, Parameter(help="Path of external calibration scripts.")
    ],
    linc: Annotated[
        cwl_dir,
        Parameter(
