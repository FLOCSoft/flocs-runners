    ...
    def run_workflow(
        ...
        if runner == "cwltool":
            ...
            try:
                ...
                with open(os.path.join(self.rundir, f"log_VLBI_{self.mode.value}.txt"), "wb") as f:
                    f.write(out)
                ...
                with open(os.path.join(self.rundir, f"log_VLBI_{self.mode.value}.txt"), "wb") as f:
                    f.write(e.stdout)
                if e.stderr:
                    with open(os.path.join(self.rundir, f"log_VLBI_{self.mode.value}_err.txt"), "wb") as f:
                        f.write(e.stderr)
